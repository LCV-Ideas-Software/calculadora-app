...
## [Unreleased]
### Alterado
- site/index.html deixou de carregar o widget/SDK SumUp e passou a encaminhar apoios para https://www.lcv.dev/sponsor?project=calculadora-app, com backend dedicado sponsor-motor via Mercado Pago Checkout Pro.
