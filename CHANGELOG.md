...
- Complete browser-bundle license notices generated by Vite's official `build.license`, published through the legal surface and checked deterministically against the lockfile, emitted JavaScript assets and the explicit Apache-2.0 election for DOMPurify.
