...
export default function ParametersPanel({ params }: Props) {
  ...
  return (
    <div className="glass-card rounded-2xl p-4" style={{ background: 'rgba(51,65,85,0.04)' }}>
      <h4 className="text-xs font-bold text-slate-500 mb-3 uppercase tracking-wider">📋 Parâmetros Vigentes</h4>
      <div className="space-y-1.5 text-sm">
        ...
        {origemLabel && <p className="text-[10px] text-slate-400 mt-2">Fonte: {origemLabel}</p>}
      </div>
    </div>
  );
}
