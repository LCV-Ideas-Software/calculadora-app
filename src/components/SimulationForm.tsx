  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="field-box">
          <label htmlFor="dataCompra" className="block text-xs font-semibold text-slate-500 mb-1">
            📅 Data da compra
          </label>
          <input
            id="dataCompra"
      ...
      <details className="field-box">
        ...
        <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            <label htmlFor="spreadPercent" className="block text-[10px] text-slate-400 mb-0.5">
              Spread Cartão (%)
            </label>
            <input
              id="spreadPercent"
          ...
          <div>
            <label htmlFor="iofPercent" className="block text-[10px] text-slate-400 mb-0.5">
              IOF Cartão (%)
            </label>
            <input
              id="iofPercent"
          ...
          <div>
            <label htmlFor="globalSpreadAberto" className="block text-[10px] text-slate-400 mb-0.5">
              Spread Global Aberto (%)
            </label>
            <input
              id="globalSpreadAberto"
              type="text"
              inputMode="decimal"
              placeholder="Auto"
              className="glass-input w-full rounded-lg px-3 py-1.5 text-sm"
          ...
          <div>
            <label htmlFor="globalSpreadFechado" className="block text-[10px] text-slate-400 mb-0.5">
              Spread Global Fechado (%)
            </label>
            <input
              id="globalSpreadFechado"
              type="text"
              inputMode="decimal"
              placeholder="Auto"
              className="glass-input w-full rounded-lg px-3 py-1.5 text-sm"
      ...
      <button
        ...
        style={{
          background: loading ? '#94a3b8' : 'linear-gradient(135deg, #ea580c, #f97316)',
          boxShadow: loading ? 'none' : '0 8px 24px -6px rgba(234,88,12,0.4)',
      ...
      {/* Error */}
      {error && <div className="rounded-xl p-3 text-sm text-red-700 bg-red-50 border border-red-200">⚠️ {error}</div>}
    </form>
  );
}
