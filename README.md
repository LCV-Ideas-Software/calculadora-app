...
**Status.** Stable. Current application version: **v04.03.05**. See [CHANGELOG.md](./CHANGELOG.md) for the full version history.
...
| Version                              | Scope                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`v04.03.05`**                      | **`/parametros` agrees with `/calcular` on D1 precedence.** With more than one D1 row for the same key, the panel endpoint let the oldest row win while the calculation used the newest; both now take the most recent row. Regression test added. Harmless in production today, where every key carries identical values.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
